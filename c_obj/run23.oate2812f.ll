...
__fresh153:
  ...
  %elt_ptr824 = getelementptr { i32, [ 0 x { i32, [ 0 x i8* ] }* ] }* %array_dereferenced823, i32 0, i32 1, i32 1
  %len_ptr825 = getelementptr { i32, [ 0 x i8* ] }** %elt_ptr824, i32 0, i32 0
  %len826 = load i32* %len_ptr825
  call void @oat_array_bounds_check( i32 %len826, i32 1 )
  %array_dereferenced827 = load { i32, [ 0 x i8* ] }** %elt_ptr824
  %elt_ptr828 = getelementptr { i32, [ 0 x i8* ] }* %array_dereferenced827, i32 0, i32 1, i32 1
  %_lhs829 = load i8** %elt_ptr828
  call void @print_string( i8* %_lhs829 )
  ret i32 0
}
