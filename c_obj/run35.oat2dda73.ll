...
__cond59:
  ...
  br i1 %bop268, label %__body58, label %__post57
...
__cond62:
  ...
  br i1 %bop271, label %__body61, label %__post60
...
__body61:
  ...
  %elt_ptr278 = getelementptr i32 %array_dereferenced277, i32 0, i32 1, i32 %_lhs274
  %len_ptr279 = getelementptr i32* %elt_ptr278, i32 0, i32 0
  %len280 = load i32* %len_ptr279
  call void @oat_array_bounds_check( i32 %len280, i32 %_lhs273 )
  %array_dereferenced281 = load i32* %elt_ptr278
  %elt_ptr282 = getelementptr i32 %array_dereferenced281, i32 0, i32 1, i32 %_lhs273
