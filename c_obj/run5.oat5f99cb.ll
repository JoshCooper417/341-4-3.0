...
__fresh131:
  ...
  %elt_ptr601 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr592, i32 0, i32 1, i32 1
  %_lhs602 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr601
  %len_ptr603 = getelementptr [ 0 x { i32, [ 0 x i32 ] }* ] %_lhs602, i32 0, i32 0
  ...
  %elt_ptr609 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr592, i32 0, i32 1, i32 1
  call void @oat_array_bounds_check( i32 %len604, i32 1 )
  %array_dereferenced610 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr609
  %elt_ptr611 = getelementptr [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr609, i32 0, i32 1, i32 1
  %_lhs612 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr611
  ret [ 0 x { i32, [ 0 x i32 ] }* ] %_lhs612
}
