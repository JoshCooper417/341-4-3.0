...
__fresh139:
  ...
  %elt_ptr639 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced638, i32 0, i32 1, i32 1
  ...
  %elt_ptr646 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced645, i32 0, i32 1, i32 1
