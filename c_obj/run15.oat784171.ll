...
__body227:
  ...
  store i32 %_lhs935, i32* %elem_ptr938
  %index_op940 = add i32 %index_op940, 1
  br label %__check226
...
__end225:
  ...
  store { i32, [ 0 x i32 ] }* %array937, { i32, [ 0 x i32 ] }** %elem_ptr944
  %index_op946 = add i32 %index_op946, 1
  br label %__check229
...
__body233:
  ...
  store i32 %bop953, i32* %elem_ptr956
  %index_op958 = add i32 %index_op958, 1
  br label %__check232
...
__end231:
  ...
  store { i32, [ 0 x i32 ] }* %array955, { i32, [ 0 x i32 ] }** %elem_ptr962
  %index_op964 = add i32 %index_op964, 1
  br label %__check235
...
__body239:
  ...
  store i32 %bop990, i32* %elem_ptr993
  %index_op995 = add i32 %index_op995, 1
  br label %__check238
...
__end237:
  ...
  store { i32, [ 0 x i32 ] }* %array992, { i32, [ 0 x i32 ] }** %elem_ptr999
  %index_op1001 = add i32 %index_op1001, 1
  br label %__check241
...
__body216:
  ...
  store i32 %_lhs906, i32* %elem_ptr909
  %index_op911 = add i32 %index_op911, 1
  br label %__check215
...
__end214:
  ...
  store { i32, [ 0 x i32 ] }* %array908, { i32, [ 0 x i32 ] }** %elem_ptr915
  %index_op917 = add i32 %index_op917, 1
  br label %__check218
