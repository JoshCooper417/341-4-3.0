...
__fresh1:
  ...
  %array_dereferenced10 = load { i32, [ 0 x i32 ] }** @arr5
  %len_ptr11 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced10, i32 0, i32 0
  %len12 = load i32* %len_ptr11
  call void @oat_array_bounds_check( i32 %len12, i32 1 )
  %elt_ptr13 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced10, i32 0, i32 1, i32 1
