...
__fresh77:
  ...
  %_lhs350 = load i32* %argc_slot349
  %ret351 = call i32 @f1 ( i32 %_lhs350 )
  ret i32 %ret351
}


define i32 @f9 (i32 %i343){

__fresh76:
  %i_slot344 = alloca i32
  store i32 %i343, i32* %i_slot344
  %_lhs345 = load i32* %i_slot344
  ret i32 %_lhs345
}


define i32 @f8 (i32 %i339){

__fresh75:
  %i_slot340 = alloca i32
  store i32 %i339, i32* %i_slot340
  %_lhs341 = load i32* %i_slot340
  %ret342 = call i32 @f9 ( i32 %_lhs341 )
  ret i32 %ret342
}


define i32 @f7 (i32 %i335){

__fresh74:
  %i_slot336 = alloca i32
  store i32 %i335, i32* %i_slot336
  %_lhs337 = load i32* %i_slot336
  %ret338 = call i32 @f8 ( i32 %_lhs337 )
  ret i32 %ret338
}


define i32 @f6 (i32 %i331){

__fresh73:
  %i_slot332 = alloca i32
  store i32 %i331, i32* %i_slot332
  %_lhs333 = load i32* %i_slot332
  %ret334 = call i32 @f7 ( i32 %_lhs333 )
  ret i32 %ret334
}


define i32 @f5 (i32 %i327){

__fresh72:
  %i_slot328 = alloca i32
  store i32 %i327, i32* %i_slot328
  %_lhs329 = load i32* %i_slot328
  %ret330 = call i32 @f6 ( i32 %_lhs329 )
  ret i32 %ret330
}


define i32 @f4 (i32 %i323){

__fresh71:
  %i_slot324 = alloca i32
  store i32 %i323, i32* %i_slot324
  %_lhs325 = load i32* %i_slot324
  %ret326 = call i32 @f5 ( i32 %_lhs325 )
  ret i32 %ret326
}


define i32 @f3 (i32 %i319){

__fresh70:
  %i_slot320 = alloca i32
  store i32 %i319, i32* %i_slot320
  %_lhs321 = load i32* %i_slot320
  %ret322 = call i32 @f4 ( i32 %_lhs321 )
  ret i32 %ret322
}


define i32 @f2 (i32 %i315){

__fresh69:
  %i_slot316 = alloca i32
  store i32 %i315, i32* %i_slot316
  %_lhs317 = load i32* %i_slot316
  %ret318 = call i32 @f3 ( i32 %_lhs317 )
  ret i32 %ret318
}


define i32 @f1 (i32 %i311){

__fresh68:
  %i_slot312 = alloca i32
  store i32 %i311, i32* %i_slot312
  %_lhs313 = load i32* %i_slot312
  %ret314 = call i32 @f2 ( i32 %_lhs313 )
  ret i32 %ret314
}
