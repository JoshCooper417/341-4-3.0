...
__cond660:
  ...
  br i1 %bop1773, label %__body659, label %__post658
...
__body659:
  ...
  %array_dereferenced1776 = load { i32, [ 0 x i32 ] }** %arr21769
  %len_ptr1777 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced1776, i32 0, i32 0
  %len1778 = load i32* %len_ptr1777
  call void @oat_array_bounds_check( i32 %len1778, i32 %_lhs1775 )
  %elt_ptr1779 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced1776, i32 0, i32 1, i32 %_lhs1775
