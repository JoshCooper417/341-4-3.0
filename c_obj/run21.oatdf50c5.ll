...
__fresh0:
  ...
  %len_ptr12 = getelementptr { i32, [ 0 x i32 ] } %array_dereference2d11, i32 0
  %len13 = load i32* %len_ptr12
  call void @oat_array_bounds_check( i32 %len13, i32 0 )
  %elt_ptr14 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced10, i32 0, i32 1, i32 0
  %_lhs15 = load i32* %elt_ptr14
  ret i32 %_lhs15
}
