...
__fresh43:
  ...
  %len_ptr163 = getelementptr { i32, [ 0 x i32 ] }** @a158, i32 0, i32 0
  %len164 = load i32* %len_ptr163
  call void @oat_array_bounds_check( i32 %len164, i32 0 )
  %array_dereferenced165 = load { i32, [ 0 x i32 ] }** @a158
  %elt_ptr166 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced165, i32 0, i32 1, i32 0
