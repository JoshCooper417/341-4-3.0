...
__fresh30:
  ...
  %len_ptr111 = getelementptr { i32, [ 0 x i32 ] }** %a110, i32 0, i32 0
  %len112 = load i32* %len_ptr111
  call void @oat_array_bounds_check( i32 %len112, i32 2 )
  %array_dereferenced113 = load { i32, [ 0 x i32 ] }** %a110
  %elt_ptr114 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced113, i32 0, i32 1, i32 2
