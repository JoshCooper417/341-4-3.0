...
__fresh686:
  ...
  %len_ptr3379 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a3378, i32 0, i32 0
  %len3380 = load i32* %len_ptr3379
  call void @oat_array_bounds_check( i32 %len3380, i32 1 )
  %array_dereferenced3381 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a3378
  %elt_ptr3382 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced3381, i32 0, i32 1, i32 1
  %len_ptr3383 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr3382, i32 0, i32 0
  %len3384 = load i32* %len_ptr3383
  call void @oat_array_bounds_check( i32 %len3384, i32 3 )
  %array_dereferenced3385 = load { i32, [ 0 x i32 ] }** %elt_ptr3382
  %elt_ptr3386 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced3385, i32 0, i32 1, i32 3
