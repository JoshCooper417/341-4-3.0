...
__body142:
  ...
  %_lhs1304 = load i32* %i1300
  %_lhs1305 = load { i32, [ 0 x i32 ] }** %arr1298
  %len_ptr1306 = getelementptr { i32, [ 0 x i32 ] }* %_lhs1305, i32 0, i32 0
  %len1307 = load i32* %len_ptr1306
  call void @oat_array_bounds_check( i32 %len1307, i32 %_lhs1304 )
  %array_dereferenced1308 = load { i32, [ 0 x i32 ] }** %arr1298
  %elt_ptr1309 = getelementptr { i32, [ 0 x i32 ] }** %arr1298, i32 0, i32 1, i32 %_lhs1304
  %_lhs1310 = load i32* %elt_ptr1309
