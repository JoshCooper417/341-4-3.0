...
__fresh153:
  ...
  %_lhs895 = load [ 0 x { i32, [ 0 x i8* ] }* ]* %elt_ptr894
  %len_ptr896 = getelementptr [ 0 x { i32, [ 0 x i8* ] }* ] %_lhs895, i32 0, i32 0
  ...
  %array_dereferenced903 = load [ 0 x { i32, [ 0 x i8* ] }* ]* %elt_ptr902
  %elt_ptr904 = getelementptr [ 0 x { i32, [ 0 x i8* ] }* ]* %elt_ptr902, i32 0, i32 1, i32 1
  %_lhs905 = load [ 0 x { i32, [ 0 x i8* ] }* ]* %elt_ptr904
  call void @print_string( [ 0 x { i32, [ 0 x i8* ] }* ] %_lhs905 )
  ret i32 0
}
