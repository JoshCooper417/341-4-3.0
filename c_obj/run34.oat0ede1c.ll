...
__body48:
  ...
  %_lhs233 = load { i32, [ 0 x i32 ] }** %elt_ptr232
  %len_ptr234 = getelementptr { i32, [ 0 x i32 ] }* %_lhs233, i32 0, i32 0
  ...
  %array_dereferenced242 = load { i32, [ 0 x i32 ] }** %elt_ptr241
  %elt_ptr243 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr241, i32 0, i32 1, i32 %_lhs226
  %_lhs244 = load i32* %elt_ptr243
