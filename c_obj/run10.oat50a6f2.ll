...
__fresh147:
  ...
  %len_ptr662 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @garr654, i32 0, i32 0
  %len663 = load i32* %len_ptr662
  call void @oat_array_bounds_check( i32 %len663, i32 1 )
  %array_dereferenced664 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @garr654
  %elt_ptr665 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced664, i32 0, i32 1, i32 1
  ...
  %len_ptr669 = getelementptr { i32, [ 0 x i32 ] }** %arr668, i32 0, i32 0
  %len670 = load i32* %len_ptr669
  call void @oat_array_bounds_check( i32 %len670, i32 1 )
  %array_dereferenced671 = load { i32, [ 0 x i32 ] }** %arr668
  %elt_ptr672 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced671, i32 0, i32 1, i32 1
