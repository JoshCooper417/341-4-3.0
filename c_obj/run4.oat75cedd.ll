...
__fresh676:
  ...
  %len_ptr3282 = getelementptr { i32, [ 0 x i32 ] }** @arr3277, i32 0, i32 0
  %len3283 = load i32* %len_ptr3282
  call void @oat_array_bounds_check( i32 %len3283, i32 2 )
  %array_dereferenced3284 = load { i32, [ 0 x i32 ] }** @arr3277
  %elt_ptr3285 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced3284, i32 0, i32 1, i32 2
