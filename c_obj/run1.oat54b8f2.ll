...
__post112:
  ...
  %elt_ptr512 = getelementptr { i32, [ 0 x i32 ] }** %arr494, i32 0, i32 1, i32 3
  %_lhs513 = load [ 0 x i32 ]* %elt_ptr512
  %ret514 = call i32 @f ( [ 0 x i32 ] %_lhs513 )
  ...
  %elt_ptr520 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @garr472, i32 0, i32 1, i32 1
  %_lhs521 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr520
  %len_ptr522 = getelementptr [ 0 x { i32, [ 0 x i32 ] }* ] %_lhs521, i32 0, i32 0
  ...
  %elt_ptr528 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @garr472, i32 0, i32 1, i32 1
  call void @oat_array_bounds_check( i32 %len523, i32 1 )
  %array_dereferenced529 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr528
  %elt_ptr530 = getelementptr [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr528, i32 0, i32 1, i32 1
  %_lhs531 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr530
  %ret532 = call i32 @f ( [ 0 x { i32, [ 0 x i32 ] }* ] %_lhs531 )
...
__fresh111:
  ...
  %elt_ptr482 = getelementptr { i32, [ 0 x i32 ] }** %y_slot477, i32 0, i32 1, i32 2
  %_lhs483 = load [ 0 x i32 ]* %elt_ptr482
  ret [ 0 x i32 ] %_lhs483
}
