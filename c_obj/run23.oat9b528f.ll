...
__fresh228:
  ...
  %len_ptr883 = getelementptr { i32, [ 0 x { i32, [ 0 x i8* ] }* ] }** @strs874, i32 0, i32 0
  %len884 = load i32* %len_ptr883
  call void @oat_array_bounds_check( i32 %len884, i32 1 )
  %array_dereferenced885 = load { i32, [ 0 x { i32, [ 0 x i8* ] }* ] }** @strs874
  %elt_ptr886 = getelementptr { i32, [ 0 x { i32, [ 0 x i8* ] }* ] }* %array_dereferenced885, i32 0, i32 1, i32 1
  %len_ptr887 = getelementptr { i32, [ 0 x i8* ] }** %elt_ptr886, i32 0, i32 0
  %len888 = load i32* %len_ptr887
  call void @oat_array_bounds_check( i32 %len888, i32 1 )
  %array_dereferenced889 = load { i32, [ 0 x i8* ] }** %elt_ptr886
  %elt_ptr890 = getelementptr { i32, [ 0 x i8* ] }* %array_dereferenced889, i32 0, i32 1, i32 1
