...
__fresh834:
  ...
  %len_ptr3304 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr3299, i32 0, i32 0
  %len3305 = load i32* %len_ptr3304
  call void @oat_array_bounds_check( i32 %len3305, i32 1 )
  %array_dereferenced3306 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr3299
  %elt_ptr3307 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced3306, i32 0, i32 1, i32 1
  %len_ptr3308 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr3307, i32 0, i32 0
  %len3309 = load i32* %len_ptr3308
  call void @oat_array_bounds_check( i32 %len3309, i32 3 )
  %array_dereferenced3310 = load { i32, [ 0 x i32 ] }** %elt_ptr3307
  %elt_ptr3311 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced3310, i32 0, i32 1, i32 3
