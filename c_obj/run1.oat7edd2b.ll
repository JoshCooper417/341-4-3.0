...
__post112:
  ...
  %elt_ptr488 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced487, i32 0, i32 1, i32 3
  ...
  %elt_ptr495 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced494, i32 0, i32 1, i32 1
  %len_ptr496 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr495, i32 0, i32 0
  %len497 = load i32* %len_ptr496
  call void @oat_array_bounds_check( i32 %len497, i32 1 )
  %array_dereferenced498 = load { i32, [ 0 x i32 ] }** %elt_ptr495
  %elt_ptr499 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced498, i32 0, i32 1, i32 1
...
__fresh111:
  ...
  %elt_ptr459 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced458, i32 0, i32 1, i32 2
