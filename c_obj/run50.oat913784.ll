...
@_oat_string432.str. = private unnamed_addr constant [ 6 x i8 ] c "abcde\00", align 4
@_oat_string432 = global i8* getelementptr inbounds ([ 6 x i8 ]* @_oat_string432.str., i32 0, i32 0), align 4
