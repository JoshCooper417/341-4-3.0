...
__fresh153:
  ...
  %_lhs895 = load i32* %elt_ptr894
  %len_ptr896 = getelementptr i32 %_lhs895, i32 0, i32 0
  ...
  %array_dereferenced903 = load i32* %elt_ptr902
  %elt_ptr904 = getelementptr i32* %elt_ptr902, i32 0, i32 1, i32 1
  %_lhs905 = load i32* %elt_ptr904
  call void @print_string( i32 %_lhs905 )
  ret i32 0
}
