...
__fresh296:
  ...
  %array_dereferenced849 = load { i32, [ 0 x i8* ] }** @strs842
  %len_ptr850 = getelementptr { i32, [ 0 x i8* ] }* %array_dereferenced849, i32 0, i32 0
  %len851 = load i32* %len_ptr850
  call void @oat_array_bounds_check( i32 %len851, i32 0 )
  %elt_ptr852 = getelementptr { i32, [ 0 x i8* ] }* %array_dereferenced849, i32 0, i32 1, i32 0
