...
__fresh127:
  ...
  %_lhs800 = load { i32, [ 0 x i8* ] }** @strs793
  %len_ptr801 = getelementptr { i32, [ 0 x i8* ] }* %_lhs800, i32 0, i32 0
  %len802 = load i32* %len_ptr801
  call void @oat_array_bounds_check( i32 %len802, i32 0 )
  %array_dereferenced803 = load { i32, [ 0 x i8* ] }** @strs793
  %elt_ptr804 = getelementptr { i32, [ 0 x i8* ] }** @strs793, i32 0, i32 1, i32 0
  %_lhs805 = load [ 0 x i8* ]* %elt_ptr804
  call void @print_string( [ 0 x i8* ] %_lhs805 )
  ret i32 0
}
