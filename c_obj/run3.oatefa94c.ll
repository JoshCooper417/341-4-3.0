...
__fresh128:
  ...
  %_lhs574 = load { i32, [ 0 x i32 ] }** @arr569
  %len_ptr575 = getelementptr { i32, [ 0 x i32 ] }* %_lhs574, i32 0, i32 0
  %len576 = load i32* %len_ptr575
  call void @oat_array_bounds_check( i32 %len576, i32 1 )
  %array_dereferenced577 = load { i32, [ 0 x i32 ] }** @arr569
  %elt_ptr578 = getelementptr { i32, [ 0 x i32 ] }** @arr569, i32 0, i32 1, i32 1
  %_lhs579 = load [ 0 x i32 ]* %elt_ptr578
  ret [ 0 x i32 ] %_lhs579
}
