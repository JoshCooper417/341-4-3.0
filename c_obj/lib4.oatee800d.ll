...
__cond382:
  ...
  br i1 %bop1714, label %__body381, label %__post380
...
__body381:
  ...
  %len_ptr1717 = getelementptr { i32, [ 0 x i32 ] }** %arr1710, i32 0, i32 0
  %len1718 = load i32* %len_ptr1717
  call void @oat_array_bounds_check( i32 %len1718, i32 %_lhs1716 )
  %array_dereferenced1719 = load { i32, [ 0 x i32 ] }** %arr1710
  %elt_ptr1720 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced1719, i32 0, i32 1, i32 %_lhs1716
