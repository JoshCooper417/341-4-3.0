...
__fresh328:
  ...
  %unop2344 = sub i32 0, 1
  %_lhs2345 = load { i32, [ 0 x i32 ] }** %a2343
  %len_ptr2346 = getelementptr { i32, [ 0 x i32 ] }* %_lhs2345, i32 0, i32 0
  %len2347 = load i32* %len_ptr2346
  call void @oat_array_bounds_check( i32 %len2347, i32 %unop2344 )
  %array_dereferenced2348 = load { i32, [ 0 x i32 ] }** %a2343
  %elt_ptr2349 = getelementptr { i32, [ 0 x i32 ] }** %a2343, i32 0, i32 1, i32 %unop2344
