...
__fresh185:
  ...
  %array_dereferenced569 = load { i32, [ 0 x i32 ] }** @arr564
  %len_ptr570 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced569, i32 0, i32 0
  %len571 = load i32* %len_ptr570
  call void @oat_array_bounds_check( i32 %len571, i32 1 )
  %elt_ptr572 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced569, i32 0, i32 1, i32 1
