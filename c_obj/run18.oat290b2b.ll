...
__fresh0:
  ...
  %len_ptr15 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced14, i32 0, i32 0
  %len16 = load i32* %len_ptr15
  call void @oat_array_bounds_check( i32 %len16, i32 2 )
  %array_dereferenced14 = load { i32, [ 0 x i32 ] }** %a13
  %elt_ptr17 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced14, i32 0, i32 1, i32 2
