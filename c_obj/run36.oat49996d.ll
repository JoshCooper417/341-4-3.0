...
__fresh920:
  ...
  %array_dereferenced3357 = load { i32, [ 0 x i32 ] }** %a3355
  %len_ptr3358 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced3357, i32 0, i32 0
  %len3359 = load i32* %len_ptr3358
  call void @oat_array_bounds_check( i32 %len3359, i32 %unop3356 )
  %elt_ptr3360 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced3357, i32 0, i32 1, i32 %unop3356
