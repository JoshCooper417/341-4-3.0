...
__fresh589:
  ...
  call void @oat_array_bounds_check( i32 %len3350, i32 3 )
  %array_dereferenced3351 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr3344
  %elt_ptr3352 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced3351, i32 0, i32 1, i32 3
  %len_ptr3353 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr3352, i32 0, i32 0
  %len3354 = load i32* %len_ptr3353
  call void @oat_array_bounds_check( i32 %len3354, i32 0 )
  %array_dereferenced3355 = load { i32, [ 0 x i32 ] }** %elt_ptr3352
  %elt_ptr3356 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced3355, i32 0, i32 1, i32 0
