...
__fresh112:
  ...
  %_lhs551 = load { i32, [ 0 x i32 ] }** @arr546
  %len_ptr552 = getelementptr { i32, [ 0 x i32 ] }* %_lhs551, i32 0, i32 0
  %len553 = load i32* %len_ptr552
  call void @oat_array_bounds_check( i32 %len553, i32 1 )
  %array_dereferenced554 = load { i32, [ 0 x i32 ] }** @arr546
  %elt_ptr555 = getelementptr { i32, [ 0 x i32 ] }** @arr546, i32 0, i32 1, i32 1
