...
__body48:
  ...
  %elt_ptr225 = getelementptr i32 %array_dereferenced224, i32 0, i32 1, i32 %_lhs221
  %len_ptr226 = getelementptr i32* %elt_ptr225, i32 0, i32 0
  %len227 = load i32* %len_ptr226
  call void @oat_array_bounds_check( i32 %len227, i32 %_lhs220 )
  %array_dereferenced228 = load i32* %elt_ptr225
  %elt_ptr229 = getelementptr i32 %array_dereferenced228, i32 0, i32 1, i32 %_lhs220
