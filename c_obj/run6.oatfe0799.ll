...
__fresh394:
  ...
  %elt_ptr2517 = getelementptr i32 %array_dereferenced2516, i32 0, i32 1, i32 1
  %len_ptr2518 = getelementptr i32* %elt_ptr2517, i32 0, i32 0
  %len2519 = load i32* %len_ptr2518
  call void @oat_array_bounds_check( i32 %len2519, i32 3 )
  %array_dereferenced2520 = load i32* %elt_ptr2517
  %elt_ptr2521 = getelementptr i32 %array_dereferenced2520, i32 0, i32 1, i32 3
