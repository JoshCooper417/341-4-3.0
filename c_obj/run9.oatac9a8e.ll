...
__fresh135:
  ...
  %elt_ptr608 = getelementptr i32 %array_dereferenced607, i32 0, i32 1, i32 1
  %len_ptr609 = getelementptr i32* %elt_ptr608, i32 0, i32 0
  %len610 = load i32* %len_ptr609
  call void @oat_array_bounds_check( i32 %len610, i32 1 )
  %array_dereferenced611 = load i32* %elt_ptr608
  %elt_ptr612 = getelementptr i32 %array_dereferenced611, i32 0, i32 1, i32 1
