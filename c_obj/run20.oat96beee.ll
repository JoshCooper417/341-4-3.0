...
__fresh34:
  ...
  %array_dereferenced129 = load { i32, [ 0 x i32 ] }** %a128
  %len_ptr130 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced129, i32 0, i32 0
  %len131 = load i32* %len_ptr130
  call void @oat_array_bounds_check( i32 %len131, i32 2 )
  %elt_ptr132 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced129, i32 0, i32 1, i32 2
