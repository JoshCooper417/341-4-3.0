...
__body61:
  ...
  %_lhs294 = load { i32, [ 0 x i32 ] }** %elt_ptr293
  %len_ptr295 = getelementptr { i32, [ 0 x i32 ] }* %_lhs294, i32 0, i32 0
  ...
  %array_dereferenced303 = load { i32, [ 0 x i32 ] }** %elt_ptr302
  %elt_ptr304 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr302, i32 0, i32 1, i32 %_lhs287
