...
__fresh397:
  ...
  %elt_ptr2543 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2542, i32 0, i32 1, i32 3
  %len_ptr2544 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2543, i32 0, i32 0
  %len2545 = load i32* %len_ptr2544
  call void @oat_array_bounds_check( i32 %len2545, i32 0 )
  %array_dereferenced2546 = load { i32, [ 0 x i32 ] }** %elt_ptr2543
  %elt_ptr2547 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2546, i32 0, i32 1, i32 0
