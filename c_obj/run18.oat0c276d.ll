...
__fresh24:
  ...
  %len_ptr92 = getelementptr { i32, [ 0 x i32 ] }** %a91, i32 0, i32 0
  %len93 = load i32* %len_ptr92
  call void @oat_array_bounds_check( i32 %len93, i32 2 )
  %array_dereferenced94 = load { i32, [ 0 x i32 ] }** %a91
  %elt_ptr95 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced94, i32 0, i32 1, i32 2
