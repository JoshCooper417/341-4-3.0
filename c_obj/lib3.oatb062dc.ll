...
__fresh377:
  ...
  %len_ptr1691 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %arr1690, i32 0, i32 0
  %len1692 = load i32* %len_ptr1691
  call void @oat_array_bounds_check( i32 %len1692, i32 0 )
  %array_dereferenced1693 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %arr1690
  %elt_ptr1694 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced1693, i32 0, i32 1, i32 0
