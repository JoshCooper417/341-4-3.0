...
__fresh145:
  ...
  %elt_ptr712 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced711, i32 0, i32 1, i32 1
  ...
  %elt_ptr719 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced718, i32 0, i32 1, i32 1
  ...
  %elt_ptr723 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced722, i32 0, i32 1, i32 1
  ...
  %elt_ptr730 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced729, i32 0, i32 1, i32 3
  ...
  %elt_ptr741 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced740, i32 0, i32 1, i32 1
...
__fresh143:
  ...
  %elt_ptr681 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced680, i32 0, i32 1, i32 3
