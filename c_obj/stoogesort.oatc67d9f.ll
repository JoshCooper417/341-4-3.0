...
__body283:
  ...
  %_lhs2038 = load [ 0 x i32 ]* %elt_ptr2037
  call void @print_int( [ 0 x i32 ] %_lhs2038 )
...
__fresh277:
  ...
  %_lhs1934 = load [ 0 x i32 ]* %elt_ptr1933
  ...
  %_lhs1941 = load [ 0 x i32 ]* %elt_ptr1940
  %bop1942 = icmp slt [ 0 x i32 ] %_lhs1934, %_lhs1941
...
__then273:
  ...
  %_lhs1949 = load [ 0 x i32 ]* %elt_ptr1948
  store [ 0 x i32 ] %_lhs1949, i32* %t1927
  ...
  %_lhs1962 = load [ 0 x i32 ]* %elt_ptr1961
  store [ 0 x i32 ] %_lhs1962, [ 0 x i32 ]* %elt_ptr1955
  ...
  store i32 %_lhs1969, [ 0 x i32 ]* %elt_ptr1968
  br label %__merge271
