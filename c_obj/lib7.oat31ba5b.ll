...
__cond410:
  ...
  br i1 %bop1806, label %__body409, label %__post408
...
__body409:
  ...
  %len_ptr1809 = getelementptr { i32, [ 0 x i32 ] }** %arr21802, i32 0, i32 0
  %len1810 = load i32* %len_ptr1809
  call void @oat_array_bounds_check( i32 %len1810, i32 %_lhs1808 )
  %array_dereferenced1811 = load { i32, [ 0 x i32 ] }** %arr21802
  %elt_ptr1812 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced1811, i32 0, i32 1, i32 %_lhs1808
