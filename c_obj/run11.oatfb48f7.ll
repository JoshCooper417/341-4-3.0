...
__fresh145:
  ...
  %elt_ptr763 = getelementptr { i32, [ 0 x i32 ] }** @arr1703, i32 0, i32 1, i32 1
  %_lhs764 = load [ 0 x i32 ]* %elt_ptr763
  ...
  %elt_ptr771 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr2724, i32 0, i32 1, i32 1
  %_lhs772 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr771
  %len_ptr773 = getelementptr [ 0 x { i32, [ 0 x i32 ] }* ] %_lhs772, i32 0, i32 0
  ...
  %elt_ptr779 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr2724, i32 0, i32 1, i32 1
  call void @oat_array_bounds_check( i32 %len774, i32 1 )
  %array_dereferenced780 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr779
  %elt_ptr781 = getelementptr [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr779, i32 0, i32 1, i32 1
  %_lhs782 = load [ 0 x { i32, [ 0 x i32 ] }* ]* %elt_ptr781
  ...
  %elt_ptr789 = getelementptr { i32, [ 0 x i32 ] }** %arr3754, i32 0, i32 1, i32 3
  %_lhs790 = load [ 0 x i32 ]* %elt_ptr789
  ...
  %elt_ptr801 = getelementptr { i32, [ 0 x i32 ] }** %arr4747, i32 0, i32 1, i32 1
  %_lhs802 = load [ 0 x i32 ]* %elt_ptr801
...
__fresh143:
  ...
  %elt_ptr731 = getelementptr { i32, [ 0 x i32 ] }** %arr_slot726, i32 0, i32 1, i32 3
  %_lhs732 = load [ 0 x i32 ]* %elt_ptr731
  ret [ 0 x i32 ] %_lhs732
}
