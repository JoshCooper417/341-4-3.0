...
__fresh136:
  ...
  %_lhs1239 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %arr1238
  %len_ptr1240 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %_lhs1239, i32 0, i32 0
  %len1241 = load i32* %len_ptr1240
  call void @oat_array_bounds_check( i32 %len1241, i32 2 )
  %array_dereferenced1242 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %arr1238
  %elt_ptr1243 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %arr1238, i32 0, i32 1, i32 2
  %_lhs1244 = load i32* %elt_ptr1243
  %len_ptr1245 = getelementptr i32 %_lhs1244, i32 0, i32 0
