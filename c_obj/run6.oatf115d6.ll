...
__fresh666:
  ...
  call void @oat_array_bounds_check( i32 %len3351, i32 1 )
  %array_dereferenced3352 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** @arr3345
  %elt_ptr3353 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced3352, i32 0, i32 1, i32 1
  %len_ptr3354 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr3353, i32 0, i32 0
  %len3355 = load i32* %len_ptr3354
  call void @oat_array_bounds_check( i32 %len3355, i32 3 )
  %array_dereferenced3356 = load { i32, [ 0 x i32 ] }** %elt_ptr3353
  %elt_ptr3357 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced3356, i32 0, i32 1, i32 3
