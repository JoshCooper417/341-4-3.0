...
__fresh156:
  ...
  %elt_ptr867 = getelementptr { i32, [ 0 x { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* ] }* %array_dereferenced866, i32 0, i32 1, i32 0
  %len_ptr868 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %elt_ptr867, i32 0, i32 0
  %len869 = load i32* %len_ptr868
  call void @oat_array_bounds_check( i32 %len869, i32 1 )
  %array_dereferenced870 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %elt_ptr867
  %elt_ptr871 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced870, i32 0, i32 1, i32 1
  %len_ptr872 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr871, i32 0, i32 0
  %len873 = load i32* %len_ptr872
  call void @oat_array_bounds_check( i32 %len873, i32 2 )
  %array_dereferenced874 = load { i32, [ 0 x i32 ] }** %elt_ptr871
  %elt_ptr875 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced874, i32 0, i32 1, i32 2
