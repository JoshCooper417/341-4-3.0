...
__fresh24:
  ...
  %_lhs92 = load { i32, [ 0 x i32 ] }** %a91
  %len_ptr93 = getelementptr { i32, [ 0 x i32 ] }* %_lhs92, i32 0, i32 0
  %len94 = load i32* %len_ptr93
  call void @oat_array_bounds_check( i32 %len94, i32 2 )
  %array_dereferenced95 = load { i32, [ 0 x i32 ] }** %a91
  %elt_ptr96 = getelementptr { i32, [ 0 x i32 ] }** %a91, i32 0, i32 1, i32 2
  %_lhs97 = load [ 0 x i32 ]* %elt_ptr96
  ret [ 0 x i32 ] %_lhs97
}
