...
__fresh453:
  ...
  %array_ptr2475 = call { i32, [ 0 x i32 ] }* @oat_alloc_array ( i32 50 )
  %array2476 = bitcast { i32, [ 0 x i32 ] }* %array_ptr2475 to { i32, [ 0 x i32 ] }* 
  %i2480 = alloca i32
  store i32 1, i32* %i2480
  %i2474 = load i32* %i2480
  br label %__check436
...
__cond440:
  ...
  br i1 %bop2493, label %__body439, label %__post438
...
__body439:
  ...
  br i1 %bop2506, label %__then443, label %__else442
...
__cond446:
  ...
  br i1 %bop2539, label %__body445, label %__post444
...
__cond449:
  ...
  br i1 %bop2557, label %__body448, label %__post447
...
__cond452:
  ...
  br i1 %bop2576, label %__body451, label %__post450
...
__fresh432:
  ...
  br i1 %bop2447, label %__then431, label %__else430
