...
__body382:
  ...
  %elt_ptr2467 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2466, i32 0, i32 1, i32 %_lhs2463
  %len_ptr2468 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2467, i32 0, i32 0
  %len2469 = load i32* %len_ptr2468
  call void @oat_array_bounds_check( i32 %len2469, i32 %_lhs2462 )
  %array_dereferenced2470 = load { i32, [ 0 x i32 ] }** %elt_ptr2467
  %elt_ptr2471 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2470, i32 0, i32 1, i32 %_lhs2462
...
__body373:
  ...
  %elt_ptr2429 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2428, i32 0, i32 1, i32 %_lhs2425
  %len_ptr2430 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2429, i32 0, i32 0
  %len2431 = load i32* %len_ptr2430
  call void @oat_array_bounds_check( i32 %len2431, i32 %_lhs2424 )
  %array_dereferenced2432 = load { i32, [ 0 x i32 ] }** %elt_ptr2429
  %elt_ptr2433 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2432, i32 0, i32 1, i32 %_lhs2424
  ...
  %elt_ptr2440 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2439, i32 0, i32 1, i32 %_lhs2436
  %len_ptr2441 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2440, i32 0, i32 0
  %len2442 = load i32* %len_ptr2441
  call void @oat_array_bounds_check( i32 %len2442, i32 %_lhs2435 )
  %array_dereferenced2443 = load { i32, [ 0 x i32 ] }** %elt_ptr2440
  %elt_ptr2444 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2443, i32 0, i32 1, i32 %_lhs2435
...
__body365:
  ...
  %elt_ptr2397 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2396, i32 0, i32 1, i32 %_lhs2393
  %len_ptr2398 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2397, i32 0, i32 0
  %len2399 = load i32* %len_ptr2398
  call void @oat_array_bounds_check( i32 %len2399, i32 %_lhs2392 )
  %array_dereferenced2400 = load { i32, [ 0 x i32 ] }** %elt_ptr2397
  %elt_ptr2401 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2400, i32 0, i32 1, i32 %_lhs2392
...
__body352:
  ...
  %elt_ptr2334 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2333, i32 0, i32 1, i32 %_lhs2330
  %len_ptr2335 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2334, i32 0, i32 0
  %len2336 = load i32* %len_ptr2335
  call void @oat_array_bounds_check( i32 %len2336, i32 %_lhs2329 )
  %array_dereferenced2337 = load { i32, [ 0 x i32 ] }** %elt_ptr2334
  %elt_ptr2338 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2337, i32 0, i32 1, i32 %_lhs2329
  ...
  %elt_ptr2344 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2343, i32 0, i32 1, i32 %_lhs2340
  %len_ptr2345 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2344, i32 0, i32 0
  %len2346 = load i32* %len_ptr2345
  call void @oat_array_bounds_check( i32 %len2346, i32 %_lhs2339 )
  %array_dereferenced2347 = load { i32, [ 0 x i32 ] }** %elt_ptr2344
  %elt_ptr2348 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2347, i32 0, i32 1, i32 %_lhs2339
  ...
  %elt_ptr2355 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2354, i32 0, i32 1, i32 %_lhs2351
  %len_ptr2356 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2355, i32 0, i32 0
  %len2357 = load i32* %len_ptr2356
  call void @oat_array_bounds_check( i32 %len2357, i32 %_lhs2350 )
  %array_dereferenced2358 = load { i32, [ 0 x i32 ] }** %elt_ptr2355
  %elt_ptr2359 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2358, i32 0, i32 1, i32 %_lhs2350
  ...
  %elt_ptr2366 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced2365, i32 0, i32 1, i32 %_lhs2362
  %len_ptr2367 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr2366, i32 0, i32 0
  %len2368 = load i32* %len_ptr2367
  call void @oat_array_bounds_check( i32 %len2368, i32 %_lhs2361 )
  %array_dereferenced2369 = load { i32, [ 0 x i32 ] }** %elt_ptr2366
  %elt_ptr2370 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced2369, i32 0, i32 1, i32 %_lhs2361
