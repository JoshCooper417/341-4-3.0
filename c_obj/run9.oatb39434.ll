...
__fresh135:
  ...
  %_lhs650 = load { i32, [ 0 x i32 ] }** %elt_ptr649
  %len_ptr651 = getelementptr { i32, [ 0 x i32 ] }* %_lhs650, i32 0, i32 0
  ...
  %array_dereferenced658 = load { i32, [ 0 x i32 ] }** %elt_ptr657
  %elt_ptr659 = getelementptr { i32, [ 0 x i32 ] }** %elt_ptr657, i32 0, i32 1, i32 1
