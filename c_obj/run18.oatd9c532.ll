...
__fresh27:
  ...
  %array_dereferenced92 = load { i32, [ 0 x i32 ] }** %a91
  %len_ptr93 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced92, i32 0, i32 0
  %len94 = load i32* %len_ptr93
  call void @oat_array_bounds_check( i32 %len94, i32 2 )
  %elt_ptr95 = getelementptr { i32, [ 0 x i32 ] }* %array_dereferenced92, i32 0, i32 1, i32 2
  %_lhs96 = load i32* %elt_ptr95
  ret i32 %_lhs96
}
