...
__fresh621:
  ...
  %array_dereferenced1653 = load { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %arr1652
  %len_ptr1654 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced1653, i32 0, i32 0
  %len1655 = load i32* %len_ptr1654
  call void @oat_array_bounds_check( i32 %len1655, i32 2 )
  %elt_ptr1656 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array_dereferenced1653, i32 0, i32 1, i32 2
  %_lhs1657 = load { i32, [ 0 x i32 ] }** %elt_ptr1656
  %len_ptr1658 = getelementptr { i32, [ 0 x i32 ] }* %_lhs1657, i32 0
